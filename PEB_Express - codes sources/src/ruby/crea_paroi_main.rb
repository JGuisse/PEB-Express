...
module Guisse
  module PEBExpress
    ...
    def self.creer_dialogue
      ...
      html_path = File.join(File.dirname(__FILE__), '../html/crea_paroi_dialog.html')
    ...
    def self.create_toolbar
      ...
      cmd.small_icon = File.join(__dir__, '../images/crea_paroi_small_icon.png')
      cmd.large_icon = File.join(__dir__, '../images/crea_paroi_big_icon.png')
