require_relative 'collect2XML' 
require 'rexml/document'
require 'json'


require_relative 'face_extraction'
require_relative 'calculations_export'
  ...
  module PEBExpress
    ...
    class << self
      ...
      def create_toolbar
        ...
        cmd.small_icon = File.join(__dir__, 'default_small_icon.png')
        cmd.large_icon = File.join(__dir__, 'default_large_icon.png')
